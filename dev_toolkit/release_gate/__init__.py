...
_PROPAGATED_ATTRS: dict[str, tuple[object, ...]] = {
    ...
    "_ensure_token": (_context, _checks),
    ...
    "audit_file_share_schema": (_checks,),
    "audit_pgvector_access": (_checks,),
    ...
    "inspect_alembic_revision_state": (_checks,),
}
