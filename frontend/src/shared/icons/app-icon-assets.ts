...
import knowledgeBasePng from '@/assets/desktop-icons/knowledge-base.png'
...
import knowledgeBaseIcon from '@fluentui/svg-icons/icons/library_32_color.svg?raw'
import agentIcon from '@fluentui/svg-icons/icons/bot_24_color.svg?raw'
...
const svgMap: Record<string, string> = {
  Files: fileManagerIcon, Delete: recycleBinIcon, Collection: knowledgeBaseIcon,
  ChatDotRound: agentIcon, Setting: settingsIcon, List: taskIcon,
