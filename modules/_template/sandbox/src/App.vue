<template>
  <div class="sandbox-shell">
    <header class="sandbox-header">
      ...
      <h1 class="sandbox-title">MODULE_DISPLAY_NAME</h1>
...
import ModuleEntry from '@modules/MODULE_KEY/frontend/index.vue'

// If your manifest uses a different component_key, update the path:
// import ModuleEntry from '@modules/MODULE_KEY/frontend/entry.vue'
</script>
