...
def register_agent_capabilities() -> None:
    ...
    from .handlers.tool_guidance import (
        _cap_activate_tool_guide,
        _cap_classify_and_degrade,
        _cap_disable_tool_guide,
        _cap_get_tool_guide,
        _cap_list_tool_guides,
        _cap_propose_tool_guide,
        _cap_render_tool_guidance,
        _cap_rollback_tool_guide,
    )
    ...
    capabilities = [
        ...
        # Tool Guidance capabilities
        ("agent", "list_tool_guides", _cap_list_tool_guides,
         "列出工具指引，可按 owner_id/agent_code/tool_name/scope/status 过滤。",
         "列出工具指引",
         {"owner_id": {"type": "integer"}, "agent_code": {"type": "string"},
          "tool_name": {"type": "string"}, "scope": {"type": "string"},
          "status": {"type": "string"}}, "viewer"),
        ("agent", "get_tool_guide", _cap_get_tool_guide,
         "获取单条工具指引详情。",
         "查看工具指引",
         {"guide_id": {"type": "integer"}}, "viewer"),
        ("agent", "propose_tool_guide", _cap_propose_tool_guide,
         "提交候选工具指引。生成 candidate 记录，待 admin 审批后晋升为 active。",
         "提交候选工具指引",
         {"tool_name": {"type": "string"}, "agent_code": {"type": "string"},
          "scope": {"type": "string"}, "title": {"type": "string"},
          "guide_text": {"type": "string"},
          "failure_policy": {"type": "object"},
          "acceptance_policy": {"type": "object"}}, "editor"),
        ("agent", "activate_tool_guide", _cap_activate_tool_guide,
         "激活工具指引：晋升 candidate 为 active，或重新启用已禁用的指引。",
         "激活工具指引",
         {"guide_id": {"type": "integer"}}, "admin"),
        ...
        ("agent", "rollback_tool_guide", _cap_rollback_tool_guide,
         "回滚工具指引到指定版本。",
         "回滚工具指引",
         {"guide_id": {"type": "integer"}, "version": {"type": "integer"}}, "admin"),
        ("agent", "render_tool_guidance", _cap_render_tool_guidance,
         "按合并顺序渲染当前上下文的工具指引。只渲染本轮可能用到的工具。",
         "渲染工具指引",
         {"agent_code": {"type": "string"},
          "tool_names": {"type": "array", "items": {"type": "string"}},
          "max_tokens": {"type": "integer"}}, "viewer"),
        ("agent", "classify_and_degrade", _cap_classify_and_degrade,
         "分类工具错误并返回降级建议。",
         "错误分类与降级",
         {"error_class": {"type": "string", "description": "已知错误分类"},
          "tool_result": {"type": "object", "description": "工具返回结果"},
          "exception": {"type": "string", "description": "异常字符串"}}, "viewer"),
    ]
