...
from modules.agent.backend.runtime import content_gate as gate
...
def test_legacy_success_path_and_source_markup_is_display_only_cleaned():
    raw = (
    ...
    assert gate.final_clean_content(raw) == ""
