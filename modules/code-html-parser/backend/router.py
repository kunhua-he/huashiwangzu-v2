...
router = APIRouter(prefix="/api/code-html-parser", tags=["code-html-parser"])
...
@router.get("/health")
async def health():
    return ApiResponse(data={"module": "code-html-parser", "status": "ok"})
...
register_capability(
    "code-html-parser", "parse", _parse,
    description="Parse HTML files into semantic content blocks",
    brief="解析 HTML",
...
register_capability(
    "code-html-parser", "reload_rules", _reload_rules,
