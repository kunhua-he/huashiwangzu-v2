...
router = APIRouter(prefix="/api/code-php-parser", tags=["code-php-parser"])
...
@router.get("/health")
async def health():
    return ApiResponse(data={"module": "code-php-parser", "status": "ok"})
...
register_capability(
    "code-php-parser", "parse", _parse,
    description="Parse PHP files into semantic code blocks",
    brief="解析 PHP 代码",
...
register_capability(
    "code-php-parser", "reload_rules", _reload_rules,
