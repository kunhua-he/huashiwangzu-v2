...
router = APIRouter(prefix="/api/code-py-parser", tags=["code-py-parser"])
...
@router.get("/health")
async def health():
    return ApiResponse(data={"module": "code-py-parser", "status": "ok"})
...
register_capability(
    "code-py-parser", "parse", _parse,
    description="Parse Python files into semantic code blocks",
    brief="解析 Python 代码",
...
register_capability(
    "code-py-parser", "reload_rules", _reload_rules,
