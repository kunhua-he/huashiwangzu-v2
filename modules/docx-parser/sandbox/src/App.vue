<template>
  <div class="sandbox-shell">
    <header class="sandbox-header">
      ...
      <h1 class="sandbox-title">DOCX Parser</h1>
...
import ModuleEntry from '@modules/docx-parser/frontend/index.vue'

// If your manifest uses a different component_key, update the path:
// import ModuleEntry from '@modules/docx-parser/frontend/entry.vue'
</script>
