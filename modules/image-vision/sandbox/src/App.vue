<template>
  <div class="sandbox-shell">
    <header class="sandbox-header">
      ...
      <h1 class="sandbox-title">Image Vision</h1>
...
import ModuleEntry from '@modules/image-vision/frontend/index.vue'

// If your manifest uses a different component_key, update the path:
// import ModuleEntry from '@modules/image-vision/frontend/entry.vue'
</script>
