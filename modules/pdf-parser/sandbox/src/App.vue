<template>
  <div class="sandbox-shell">
    <header class="sandbox-header">
      ...
      <h1 class="sandbox-title">PDF Parser</h1>
...
import ModuleEntry from '@modules/pdf-parser/frontend/index.vue'

// If your manifest uses a different component_key, update the path:
// import ModuleEntry from '@modules/pdf-parser/frontend/entry.vue'
</script>
