...
- **Fetch**: SSRF-protected — blocks internal/private IP ranges (localhost, 10.x, 172.16-31.x, 192.168.x, etc.) and non-http(s) protocols. Rejects binary content types early. Strips script/style/nav/footer before extracting text.
