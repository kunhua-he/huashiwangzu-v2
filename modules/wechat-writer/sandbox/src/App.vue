<template>
  <div class="sandbox-shell">
    <header class="sandbox-header">
      ...
      <h1 class="sandbox-title">公众号写作助手</h1>
...
import ModuleEntry from '@modules/wechat-writer/frontend/index.vue'

// If your manifest uses a different component_key, update the path:
// import ModuleEntry from '@modules/wechat-writer/frontend/entry.vue'
</script>
