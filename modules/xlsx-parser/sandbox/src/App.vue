<template>
  <div class="sandbox-shell">
    <header class="sandbox-header">
      ...
      <h1 class="sandbox-title">XLSX CSV Parser</h1>
...
import ModuleEntry from '@modules/xlsx-parser/frontend/index.vue'

// If your manifest uses a different component_key, update the path:
// import ModuleEntry from '@modules/xlsx-parser/frontend/entry.vue'
</script>
