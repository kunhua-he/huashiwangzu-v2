...
| 嵌入服务 | Qwen3-Embedding-8B OpenAI-compatible `/v1/embeddings`，端口 `30004`；旧 bge-m3 1024D 仅保留兼容路径 |
...
| 知识库后台任务统一调度目标架构 | `开发文档/02_底层开发文档/knowledge-task-dispatcher-architecture.md` |
| Agent 对话执行编排重构方案 | `开发文档/03_模块开发文档/agent-runtime-orchestration-architecture.md` |
