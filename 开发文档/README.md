...
| 开发工具台 | **`dev_toolkit/` 项目 MCP**（`.mcp.json` 注册），核心工具含 brief/probe/call_capability/routes/capabilities/db_schema/tail_log/run_test/lint/code_explore/code_node/code_impact/quick_fix_preview/quick_fix_patch + memory_search/write/recent + smoke。**接手先连它**，详见 `dev_toolkit/README.md` |
